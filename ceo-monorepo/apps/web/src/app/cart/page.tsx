...
const mockCartItems = [
  { id: 1, productId: 1, name: '醫療口罩', price: 150, quantity: 3, image: '/placeholder-product.svg', unit: '盒' },
  { id: 2, productId: 3, name: '血壓計', price: 2450, quantity: 1, image: '/placeholder-product.svg', unit: '台' },
  { id: 3, productId: 5, name: '體溫槍', price: 1200, quantity: 2, image: '/placeholder-product.svg', unit: '支' },
];
