...
export default function HomePage() {
  ...
  const featuredProducts = [
    { id: 1, name: '醫療口罩', price: 150, originalPrice: 200, discount: 25, image: '/placeholder-product.svg' },
    { id: 2, name: '酒精乾洗手', price: 280, originalPrice: 350, discount: 20, image: '/placeholder-product.svg' },
    { id: 3, name: '血壓計', price: 2450, originalPrice: 2900, discount: 15, image: '/placeholder-product.svg' },
    { id: 4, name: '血糖儀', price: 1800, originalPrice: 2200, discount: 18, image: '/placeholder-product.svg' },
  ];
