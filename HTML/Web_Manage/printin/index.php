...
where 1 $sqlstr and ceo_order.mid =".$mid." and $table.isshow != '4' and `createtime3` IS NULL and (car.timeend < '".date("Y-m-d H:i:s")."' or $table.isshow = '2') group by $table.pid,$table.uid order by $table.uid";
  ...
  $db = new Database($HS, $ID, $PW, $DB);
	...
	$title = "<table width=\"100%\" cellspacing=\"0\" class=\"list-table\"><thead><th align=\"center\" >No.</th><th align=\"center\" >客戶名稱</th><th align=\"center\" >統一編號</th><th align=\"center\" >商品編號</th><th align=\"center\" >商品名稱</th><th align=\"center\" >供應商</th><th align=\"center\" >數量</th><th align=\"center\" >單價</th><th align=\"center\" >金額</th></thead><tbody id=\"the-list\" class=\"list:cat\">".$title."<tr><td align=\"right\" colspan=\"6\">銷售合計<td><td align=\"center\">".$allsum."<td></tr></tbody></table>";
  return $title;
}
