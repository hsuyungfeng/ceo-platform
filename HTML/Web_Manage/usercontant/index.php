...
if ($keyword!="" && $stype!==""){
	switch($stype){
		...
		break;
		case 1:
			$sqlstr=" and $table.content like '%$keyword%' ";
		break;
		case 2:
			$sqlstr=" and $table.content2 like '%$keyword%' ";
		break;
...
where 1 $sqlstr and aid='0' order by $table.id desc";
...
<!--<p class="slide"><a href="add.php" class="btn-slide">新增</a></p>-->
		...
		<select id="stype" name="stype">
            ...
            <option value="0" <?php echo ($stype=="0") ? "selected" : ""?>>會員</option>
            <option value="1" <?php echo ($stype=="1") ? "selected" : ""?>>留言內容</option>
            <option value="2" <?php echo ($stype=="2") ? "selected" : ""?>>回覆內容</option>
          </select>  
    ...
    <th width="120" align="center" >會員 </th>
	<th width="120" align="center" >留言內容</th>
    <!--<th width="120" align="center" >回覆內容</th>-->
   ...
   <!--  <th width="60" height="28" align="center" >上移</th>
	...
	<th width="60" height="28" align="center" >回覆</th>
...
?>
	<tr>
      ...
      <td align="center"><?php echo $row["uid_title"]?></td>
	  
	  <td align="center"><?php echo $row["content"]?></td>
      
      <!--<td align="center"><?php echo $row["content2"]?></td>-->
     ...
     <!-- <td align="center"><a href="?remove=up&amp;nid=<?php echo $row["id"]."&".$querystr ?>">上移</a></td>
	  ...
	  <td align="center"><a href="edit.php?id=<?php echo $row["id"]?>">查看回覆內容</a></td>
