...
<!--<p class="slide"><a href="add.php" class="btn-slide">新增</a></p>-->
		...
		<select id="stype" name="stype">
            ...
            <option value="1" <?php echo ($stype=="1") ? "selected" : ""?>>主要聯絡人</option>
            <option value="2" <?php echo ($stype=="2") ? "selected" : ""?>>聯絡電話</option>
            <option value="3" <?php echo ($stype=="3") ? "selected" : ""?>>行動電話</option>
            <option value="4" <?php echo ($stype=="4") ? "selected" : ""?>>電子信箱</option>
          </select>  
...
?>
	<tr>
     ...
     <!-- <td align="center"><a href="?remove=up&amp;nid=<?php echo $row["id"]."&".$querystr ?>">上移</a></td>
	  ...
	  <td align="center"><a href="edit.php?id=<?php echo $row["id"]?>">回覆</a></td>
