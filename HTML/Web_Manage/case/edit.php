...
<table width="871" border="0" cellpadding="0" cellspacing="3">
  <tr>
    ...
    <td width="299" rowspan="7" style="padding-left:10px;">大圖<br />
  ...
  <tr>
    ...
    <td><label>
      <input type="text" name="people" id="people" value="<?php echo $people ?>" />
    </label></td>
  </tr>
  ...
  <tr>
    ...
    <td><label>
      <input type="text" name="pack" id="pack" value="<?php echo $pack ?>" />
    </label></td>
  </tr>
  ...
  <tr>
    ...
    <td><label>
      <input type="text" name="money" id="money" value="<?php echo $money ?>" />
    </label></td>
  </tr>
